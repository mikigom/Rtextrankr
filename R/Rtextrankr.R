...
# Some useful keyboard shortcuts for package authoring: Build and
# Reload Package: 'Ctrl + Shift + B' Check Package: 'Ctrl + Shift + E'
...
#' Example will be shown in \href{https://github.com/mikigom/Rtextrankkr}{github}.
#'
